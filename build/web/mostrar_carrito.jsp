...
<%
   // new MedioPagoDAO().SetMedioPagoById(212," nombreTitular", "numeroTarjeta", "me", "an");
  Usuario usuario= (Usuario) session.getAttribute("usuario");//si usr de la sesion es nulo convoca pag index y manda ese msg(HACER ESTO)
  if (usuario==null) { %>
...
<html>
    ...
    <body>
        ...
        <div class="container"> 
            ...
            <br>
<!--si del enlace(envia del carrito y prod)-->
        <%
            ...
            <table class="table table-hover table-striped ">
               ...
               <% 
                ...
                <tr>
                    ...
                    <!--hace referencias segunn las opciones-->
