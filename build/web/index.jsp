...
<%@page import="model.MedioPago" session="true"%>
<%@page import="dao.MedioPagoDAO" session="true"%>
...
<html>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <%if(usuario==null){%><!--scriptlet-->
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="#"><span class="glyphicon glyphicon-user"></span> <%= usuario.getNombre()%></a></li> <!--es una espresion donde se lee li del usr-->
        ...
        <div class="container"> 
            ...
            <% if (request.getParameter("msjlog")!=null) { %><!--si en el request hay mgs dif de nulo=alert""-->
            ...
            <% } %>
                ...
                for (Producto producto: listaProductos) { %><!--por c/elem se agrega un div-->
